...
from dashboard.db import get_session, UserTrade, DailyPrice
from dashboard.loaders import load_stock_prices, load_stock_list
...
def _render_trade_mc(trade, current_price: float, n_sim: int = 500, days: int = 20) -> None:
